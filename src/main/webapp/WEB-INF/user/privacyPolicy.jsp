...
<head>
    ...
    <link rel="stylesheet" href="/assets/user/css/policy/privacy.css">
...
<div class="website-wrapper">
    ...
    <div class="privacy-policy">
        ...
        <h3>Mục đích và phạm vi thu thập thông tin:</h3>
        ...
        <p>Thông tin sẽ được lưu trữ vĩnh viễn cho đến quý khách không sử dụng dịch vụ của chúng tôi nữa.</p>

        <h3>Địa chỉ của đơn vị thu thập và quản lý thông tin cá nhân Lý Phân Phối Thuốc</h3>
        <p>Khu phố 6, Phường Linh Trung, Quận Thủ Đức, TPHCM</p>
        <p>Hotline: 028 999 9999</p>
        ...
        <h3>Cam kết bảo mật thông tin cá nhân khách hàng:</h3>
