<%@ page import="vn.edu.hcmuaf.fit.model.ProductCategories" %>
<%@ page import="vn.edu.hcmuaf.fit.model.ProductTypes" %>
<%@ page import="vn.edu.hcmuaf.fit.model.Supplier" %>
        ...
        <div class="content container-fluid">
            <div class="row">
                <div class="col-xl-8 offset-xl-2">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="edit-product?type=edit" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input name="categoryId" type="number" class="form-control" value="${product.categories.id}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input name="purpose" type="text" class="form-control" value="${product.purpose}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-md-2">Chỉ định</label>
                                    <div class="col-md-10">
                                        <input name="contraindications" type="text" class="form-control" value="${product.contraindications}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-md-2">Thành phần</label>
                                    <div class="col-md-10">
                                        <input name="ingredients" type="text" class="form-control" value="${product.ingredients}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-md-2">Liều lượng</label>
                                    <div class="col-md-10">
                                        <input name="dosage" type="text" class="form-control" value="${product.dosage}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-md-2">Hướng dẫn</label>
                                    <div class="col-md-10">
                                        <input name="instructions" type="text" class="form-control" value="${product.instructions}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-md-2">Thời hạn sử dụng</label>
                                    <div class="col-md-10">
                                        <input name="warrantyPeriod" type="text" class="form-control" value="${product.warrantyPeriod}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-md-2">Bảo quản</label>
                                    <div class="col-md-10">
                                        <input name="storageCondition" type="text" class="form-control" value="${product.storageCondition}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-md-2">Loại sản phẩm</label>
                                    <div class="col-md-10">
                                        <input name="typeId" type="number" class="form-control" value="${product.type.id}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-md-2">ID NCC</label>
                                    <div class="col-md-10">
                                        <input name="supplierId" type="number" class="form-control" value="${product.supplier.id}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-md-2">Hoạt động</label>
                                    <div class="col-md-10">
                                        <input name="active" type="text" class="form-control" value="${product.active}">
                                    </div>
                                </div>
                                <div class="mt-4">
