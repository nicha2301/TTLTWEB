            ...
            <div class="page-header">
                <div class="row">
                    <div class="col">
                        <h3 class="page-title">
                            <c:choose>
                                <c:when test="${param.type eq 'add'}">Thêm Admin</c:when>
                                <c:when test="${param.type eq 'edit'}">Sửa Admin</c:when>
                                <c:otherwise>Quản lí Admin</c:otherwise>
                            </c:choose>
                        </h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="list-admin">Admin</a></li>
                    ...
                    <c:if test="${param.type == 'add' || param.type == null}">
                        <div class="col-auto text-right">
                            <a href="list-admin?type=add" class="btn btn-primary add-button ml-3">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                    ...
                                    <table class="table table-hover table-center mb-0 datatable">
                                        ...
                                        <c:forEach var="user" items="${users}">
                                            <tr class="user-item" data-id="${user.id}">
                                                ...
                                                <td class="text-right">
                                                    <a href="list-admin?type=edit&id=${user.id}"
                            ...
                            <c:if test="${type.equals('add')}">
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-md-2">Tên Admin</label>
                                    <div class="col-md-10">
                                        <input id="add-username" name="username" type="text" class="form-control" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-md-2">Email</label>
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-md-2">Password</label>
                                    <div class="col-md-10">
                                        <input id="add-password" name="password" type="text" class="form-control" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="mt-4">
                                    <button class="btn btn-primary add-admin">Lưu</button>
                                    <a href="list-admin" class="btn btn-link">Hủy</a>
                                </div>
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status !== "success") {
                        ...
                        window.location.href = context + "/admin/list-admin";
                    }
                },
