        ...
        <div class="form-container" style="height: 560px">
            <form id="form" class="sign-in-form" style="margin-top: 14%; transform: translateY(-20%)">
                ...
                <div class="social-icons">
                    ...
                    <a id="discord-login-link" href="https://discord.com/oauth2/authorize?client_id=1255854814747689012&response_type=code&redirect_uri=http%3A%2F%2Flocalhost%3A8080%2Fuser%2Fsignin%3Fapis%3DDiscord&scope=email+identify+connections+guilds+gdm.join+guilds.join">
